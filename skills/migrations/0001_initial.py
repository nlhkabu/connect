...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('skills_userskill', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('skill', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['skills.Skill'])),
            ('proficiency', self.gf('django.db.models.fields.CharField')(max_length=2, default=10)),
        ))
        db.send_create_signal('skills', ['UserSkill'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('skills_userskill')
    ...
    models = {
        ...
        'skills.skill': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'owner': ('django.db.models.fields.related.ManyToManyField', [], {'through': "orm['skills.UserSkill']", 'to': "orm['auth.User']", 'symmetrical': 'False'})
        },
        'skills.userskill': {
            'Meta': {'object_name': 'UserSkill'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'proficiency': ('django.db.models.fields.CharField', [], {'max_length': '2', 'default': '10'}),
