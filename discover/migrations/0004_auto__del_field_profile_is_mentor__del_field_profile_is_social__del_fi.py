...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'profiles.connectpreferences': {
            'Meta': {'object_name': 'ConnectPreferences'},
        ...
        'profiles.profile': {
            ...
            'connect_preferences': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['profiles.ConnectPreferences']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
