...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('moderation_userregistration', (
            ...
            ('moderator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='inviter', to=orm['auth.User'])),
            ('approved_datetime', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('moderation', ['UserRegistration'])


    def backwards(self, orm):
        # Deleting model 'UserRegistration'
        db.delete_table('moderation_userregistration')
