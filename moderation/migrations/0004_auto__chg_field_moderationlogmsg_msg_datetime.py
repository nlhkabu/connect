...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ModerationLogMsg.msg_datetime'
        db.alter_column('moderation_moderationlogmsg', 'msg_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'ModerationLogMsg.msg_datetime'
        db.alter_column('moderation_moderationlogmsg', 'msg_datetime', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'moderation.moderationlogmsg': {
            ...
            'msg_datetime': ('django.db.models.fields.DateTimeField', [], {'blank': 'True', 'auto_now_add': 'True'}),
