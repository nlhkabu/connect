...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserRegistration.auth_token'
        db.add_column('moderation_userregistration', 'auth_token',
                      self.gf('django.db.models.fields.CharField')(max_length=40, default='token'),
                      keep_default=False)

        # Adding field 'UserRegistration.auth_token_is_used'
        db.add_column('moderation_userregistration', 'auth_token_is_used',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserRegistration.auth_token'
        db.delete_column('moderation_userregistration', 'auth_token')

        # Deleting field 'UserRegistration.auth_token_is_used'
        db.delete_column('moderation_userregistration', 'auth_token_is_used')
    ...
    models = {
        ...
        'moderation.userregistration': {
            ...
            'moderator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'related_name': "'inviter'"}),
