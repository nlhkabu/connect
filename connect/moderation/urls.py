...
urlpatterns = patterns('',
    ...
    url(_(r'^revoke-invitation/$'), views.revoke_invitation, name='revoke-invitation'),
    url(_(r'^review-applications/$'), views.review_applications, name='review-applications'),
    url(_(r'^review-abuse-reports/$'), views.review_abuse, name='review-abuse'),
    url(_(r'^logs/$'), views.view_logs, name='logs'),
    url(_(r'^(?P<user_id>\d+)/report-abuse/$'), views.report_abuse, name='report-abuse'),
